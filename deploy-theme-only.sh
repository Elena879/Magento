...
php bin/magento setup:static-content:deploy en_US uk_UA -f -a frontend --theme Magento/luma --jobs=4
php bin/magento setup:static-content:deploy en_US uk_UA -f -a frontend --theme Lena/luma --jobs=4
php bin/magento setup:static-content:deploy en_US uk_UA -f -a adminhtml --jobs=4
