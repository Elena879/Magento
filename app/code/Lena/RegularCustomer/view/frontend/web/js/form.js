define([
    ...
    $.widget('lena.regularCustomerForm', {
        options: {
            action: '',
            productName: ''
        },
        ...
        _create: function () {
            ...
            $(document).on('lena_regular_customer_form_open', this.openModal.bind(this));
            $(this.element).on('submit.lena_regular_customer_form', this.sendRequest.bind(this));
        },
    ...
    return $.lena.regularCustomerForm;
});
